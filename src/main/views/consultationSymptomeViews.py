...
class ConsultationSymptomeResource(Resource):
    ...
    def post(current_user:User,self):
        ...
        if pcsid:  
            ...
            data.save()
        return consultation_symptome_schema.dump(data) if data else jsonify({"error": "Not found"}, 404)
    ...
    def put(current_user:User,self): 
        ...
        if pcsid:
            ...
            if data:                
                ...
                db.session.commit()
        return consultation_symptome_schema.dump(data.first_or_404(description='Not Found!')) if data else jsonify({"error": "Not found"}, 404)
